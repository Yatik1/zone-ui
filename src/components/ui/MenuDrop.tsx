...
function MenuDrop({chatName, chatID} : {chatName:string, chatID?:string}) {
  return (
    <div className="w-[7rem] absolute z-10 top-[1rem] bg-white border border-gray-200 rounded-xl px-2 py-1.5 flex flex-col items-center justify-center">
        ...
        <span className="flex items-center justify-center p-1 w-full gap-2 hover:bg-gray-50">
            <Share size={15} /> 
            <p className="text-sm">Share</p>
        </span>

        <span className="flex items-center justify-center p-1 w-full gap-2 text-red-500 hover:bg-gray-50">
            <Trash size={15} /> 
